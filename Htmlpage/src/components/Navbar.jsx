...
function Navbar() {
  ...
  <TrendingUpIcon className="text-white text-lg sm:text-xl lg:text-2xl" />
          ...
          {/* Desktop Button */}
          <button className="hidden md:block bg-amber-600 text-white px-7 py-2.5 rounded-xl font-semibold hover:bg-amber-700 transition">
            Register
          </button>
...
{menuOpen && (
  <div className="md:hidden pb-6">
    ...
    <button className="block mx-auto mt-4 px-5 bg-amber-600 text-white py-3 rounded-xl font-semibold hover:bg-amber-700 transition">
      Register
    </button>
  </div>
)}
